...
public class LadderRotator : MonoBehaviour {
    ...
    void Start () {
		...
		Rotators = GameObject.Find ("TheTasks/SecondTask/Rotators");
    ...
    void OnMouseDrag()
    {
		...
		if (RNum == 1 /*&& screenPoint.z > 0*/) {
			...
			ST.ladders[ST.texL].transform.Rotate(new Vector3(((curPosition.y - gameObject.transform.position.y) + (curPosition.x - gameObject.transform.position.x))/3, 0, 0));
		...
		} else if (RNum == 3 /*&& screenPoint.z < 0*/) {
			...
			ST.ladders[ST.texL].transform.Rotate(new Vector3(0, 0, ((curPosition.y - gameObject.transform.position.y) - (curPosition.x - gameObject.transform.position.x))/3));
			...
			ST.ladders[ST.texL].transform.Rotate(new Vector3(0, (curPosition.y - gameObject.transform.position.y) - (curPosition.x - gameObject.transform.position.x), 0));
